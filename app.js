...
const player = new AudioPlayer('.audioPlayer', [
   { name: 'Hello', url: 'songs/01 Hello.mp3', artist: 'Adele'}, 
   ...
   {url: 'songs/03 Sing.mp3', name: 'Sing', artist: 'Ed Sheeran'},
   {url: 'songs/03 Warm Enough.mp3', name: 'Warm Enough', artist: 'Donnie Trumpet'},
   {url: 'songs/04 Don\'t.mp3', name: 'Don\'t', artist:'Ed Sheeran'},
   {url: 'songs/04 Nothing Came to Me.mp3', name: 'Nothing Came To Me', artist:'Donnie Trumpet'},
   {url: 'songs/05 Happy (From _Despicable Me 2_).mp3', name: 'Happy', artist: 'Pharrell'},
   {url: 'songs/04 When We Were Young.mp3', name: 'When We Were Young', artist:'Adele'},
   {url: 'songs/05 Remedy.mp3', name: 'Remedy', artist:'Adele'},
   {url: 'songs/05 Wanna Be Cool.mp3', name: 'Wanna Be Cool', artist:'Donnie Trumpet'},
   {url: 'songs/06 Water Under the Bridge.mp3', name: 'Water Under The Bridge', artist:'Adele'},
   {url: 'songs/07 Caretaker.mp3', name: 'Caretaker', artist: 'Donnie Trumpet feat. DRAM'},
   {url: 'songs/07 River Lea.mp3', name: 'River Lea', artist:'Adele'},
